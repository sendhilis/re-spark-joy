...
const mappings: TransactionGLMapping[] = [
  ...
  // Transfers
  { transactionType: "P2P Transfer", description: "Customer sends money to another Rukisha user", debitGL: "2010", debitName: "Sender Wallet Liability", creditGL: "2010", creditName: "Receiver Wallet Liability", feeDebitGL: "2010", feeDebitName: "Sender Wallet", feeCreditGL: "4010", feeCreditName: "P2P Transfer Fees", category: "Transfer" },
