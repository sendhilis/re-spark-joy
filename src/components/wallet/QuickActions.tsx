...
import { Send, Receipt, PiggyBank, CreditCard, Smartphone, Building, GraduationCap, QrCode, Globe, ArrowRightLeft, Banknote, Plane, ArrowDownToLine, ArrowUpFromLine, MapPin, ShoppingBag, Network, Globe2, CalendarClock } from "lucide-react";
...
import { LipafoPayFlow } from "./flows/LipafoPayFlow";
...
export function QuickActions({ onVirtualCardClick, virtualCardOpen: externalVirtualCardOpen, onVirtualCardOpenChange }: QuickActionsProps) {
  ...
  return (
    <Card className="glass-card p-6">
      ...
      <LipafoPayFlow open={lipafoPayOpen} onOpenChange={setLipafoPayOpen} />
